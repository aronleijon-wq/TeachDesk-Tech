...
const derivativeQuestions: Question[] = [
  ...
  [
    ...
    "2p model, 2p derivative, 1p answer",
    ...
    versions: [
      {
        ...
        approved: true,
        questions: derivativeQuestions.slice(0, 8),
      },
    ],
    attendance: students
      .filter((s) => s.classId === "math3c")
    ...
    versions: [
      {
        ...
        approved: true,
        questions: derivativeQuestions.slice(0, 9),
      },
    ],
    attendance: students
      .filter((s) => s.classId === "phys2")
      .map((s) => ({ studentId: s.id, status: "pending" as const })),
  },
  {
    id: "exam-democracy",
    ...
    versions: [
      {
        ...
        approved: true,
        questions: derivativeQuestions.slice(0, 10),
      },
    ],
...
const todayEvents: CalendarEvent[] = [
  {
    ...
    date: "today",
    time: "08:30",
    title: "Mathematics 3C — Derivatives review",
    classId: "math3c",
    room: "B214",
    kind: "lesson",
    students: 27,
